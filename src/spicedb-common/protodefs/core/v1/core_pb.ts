...
export enum ReachabilityEntrypoint_ReachabilityEntrypointKind {
   ...
   *
   * @generated from enum value: SELF_ENTRYPOINT = 3;
   */
  SELF_ENTRYPOINT = 3,
}
...
export type SetOperation_Child = Message<"core.v1.SetOperation.Child"> & {
  ...
  childType: {
    ...
    /**
     * @generated from field: core.v1.SetOperation.Child.Self _self = 9;
     */
    value: SetOperation_Child_Self;
    case: "Self";
  } | { case: undefined; value?: undefined };
 ...
 *
 * @generated from message core.v1.SetOperation.Child.Self
 */
export type SetOperation_Child_Self = Message<"core.v1.SetOperation.Child.Self"> & {
};

/**
 * Describes the message core.v1.SetOperation.Child.Self.
 * Use `create(SetOperation_Child_SelfSchema)` to create a new message.
 */
export const SetOperation_Child_SelfSchema: GenMessage<SetOperation_Child_Self> = /*@__PURE__*/
  messageDesc(file_core_v1_core, 24, 0, 2);
