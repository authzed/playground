...
class RelationTuple$Type extends MessageType<RelationTuple> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* core.v1.ContextualizedCaveat caveat */ 3:
                    ...
                    break;
                case /* core.v1.RelationshipIntegrity integrity */ 4:
                    message.integrity = RelationshipIntegrity.internalBinaryRead(reader, reader.uint32(), options, message.integrity);
                    break;
                case /* google.protobuf.Timestamp optional_expiration_time */ 5:
                    message.optionalExpirationTime = Timestamp.internalBinaryRead(reader, reader.uint32(), options, message.optionalExpirationTime);
                    break;
                default:
    ...
    internalBinaryWrite(message: RelationTuple, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* core.v1.RelationshipIntegrity integrity = 4; */
        if (message.integrity)
            RelationshipIntegrity.internalBinaryWrite(message.integrity, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        /* google.protobuf.Timestamp optional_expiration_time = 5; */
        if (message.optionalExpirationTime)
            Timestamp.internalBinaryWrite(message.optionalExpirationTime, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
...
class RelationshipIntegrity$Type extends MessageType<RelationshipIntegrity> {
    ...
    create(value?: PartialMessage<RelationshipIntegrity>): RelationshipIntegrity {
        const message = { keyId: "", hash: new Uint8Array(0) };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<RelationshipIntegrity>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RelationshipIntegrity): RelationshipIntegrity {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* bytes hash */ 2:
                    ...
                    break;
                case /* google.protobuf.Timestamp hashed_at */ 3:
                    message.hashedAt = Timestamp.internalBinaryRead(reader, reader.uint32(), options, message.hashedAt);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: RelationshipIntegrity, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string key_id = 1; */
        if (message.keyId !== "")
        ...
        if (message.hashedAt)
            Timestamp.internalBinaryWrite(message.hashedAt, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class AllowedRelation$Type extends MessageType<AllowedRelation> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* core.v1.AllowedCaveat required_caveat */ 6:
                    ...
                    break;
                case /* core.v1.ExpirationTrait required_expiration */ 7:
                    message.requiredExpiration = ExpirationTrait.internalBinaryRead(reader, reader.uint32(), options, message.requiredExpiration);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: AllowedRelation, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* core.v1.ExpirationTrait required_expiration = 7; */
        if (message.requiredExpiration)
            ExpirationTrait.internalBinaryWrite(message.requiredExpiration, writer.tag(7, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class ExpirationTrait$Type extends MessageType<ExpirationTrait> {
    ...
    create(value?: PartialMessage<ExpirationTrait>): ExpirationTrait {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<ExpirationTrait>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ExpirationTrait): ExpirationTrait {
        return target ?? this.create();
    }
    internalBinaryWrite(message: ExpirationTrait, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
